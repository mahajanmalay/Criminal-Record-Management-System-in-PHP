...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    if($numExistRows > 0){
        $sql="UPDATE `criminaltable` SET `police` = '$police' WHERE `criminaltable`.`id` = '$c_id'";
...
<body>
    ...
    <div class="updatePolice">
        <h3>Add/Update Police Station by Case ID</h3>
        <form action="addpolice.php" method="post">
            <label for="c_id">C_ID</label>
            <input type="number" name="c_id" >
            <label for="set_police">Set Police</label>
            <input type="varchar" name="police" ><br>
