...
<?php
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
        ...
        if($numExistRows > 0){
            $sql="UPDATE `criminaltable` SET `report` = '$report' WHERE `criminaltable`.`id` = '$c_id'";
...
<body>
    ...
    ?>
        <div class="formpolice">

            <h3>Add/Update Report by Case ID</h3>
            <form action="police.php" method="post">
                <label for="c_id">C_ID : </label>
                <input type="number" name="c_id" ><br>
                <label for="report">Report : </label>
                <textarea name="report" id="report" cols="150" rows="3" class="reportinsert"></textarea><br>
