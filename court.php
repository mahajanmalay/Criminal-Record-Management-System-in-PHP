...
<?php
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
        ...
        if($numExistRows > 0){
            $sql="UPDATE `criminaltable` SET `punishment` = '$punishment' WHERE `criminaltable`.`id` = '$c_id'";
